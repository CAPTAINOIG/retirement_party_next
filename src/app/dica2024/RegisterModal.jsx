...
const RegisterModal = ({ isOpen, onClose }) => {
  ...
  return (
    <Drawer isOpen={isOpen} onClose={onClose} size="2xl" title="Book your seat" width={650} hideCloseButton>
      <DrawerContent>
        <DrawerBody className="md:p-12">
          <div className="flex items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold">Book your seat</h1>
              <p className="mt-1 text-lg">We are excited to register you for our private unveiling</p>
            </div>
            <Button isIconOnly variant="bordered" color="danger" radius="full" onPress={onClose}>
              <TbX size="20" />
            </Button>
          </div>
          {view === 'form' && (
