...
import { useDeleteReceipt, useGetReceipt } from "@/api/invoice";
...
import ReceiptDetails from "@/components/core/dashboard/invoices/ReceiptDetails";

const ReceiptDetailsPage = ({ params: { id } }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      router.replace('/dashboard/invoices/receipts');
                ...
                <>
                  <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center space-x-3">
                      <Link href={ "/dashboard/invoices/receipts" }>
                        <IconButton
