...
const classes = {
  ...
  primary: {
    filled: 'bg-primary-200 hover:bg-primary-300 text-white focus:ring-4 focus:ring-primary-600 focus:ring-opacity-20',
    outlined:
    ...
    const _className = cn(
      {
        ...
        'px-3 py-[2.5px] text-[.94rem]': size === 'sm',
        'px-6 py-2': size === 'md',
        'px-7 py-3': size === 'lg',
    ...
    return (
      ...
      >
        {loading ? (
          ...
          <>
            {!!leftIcon && (
              <span className={cn('mr-3', { 'mr-2': size === 'sm', 'mr-1.5': size === 'xs' })}>{leftIcon}</span>
            )}
            <span className="flex-1">{children}</span>
            {!!rightIcon && (
              <span className={cn('ml-3', { 'ml-2': size === 'sm', 'ml-1.5': size === 'xs' })}>{rightIcon}</span>
            )}
          </>
        )}
      </button>
