    ...
    <div ref={ parent } className="w-full grid grid-cols-6 gap-2 md:gap-4" onInput={ handleInput }>
      {
        Array(length).fill(null).map((_, i) => (
          <input
            ...
            className={
              classNames(
                'inline-flex px-2 py-4 sm:px-2 sm:py-5 rounded-xl border border-zinc-300 focus:ring focus:ring-blue-100 text-xl text-center',
...
export default forwardRef(OtpPinInput);
