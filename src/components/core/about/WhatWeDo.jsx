        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-4 relative">
            <div className="sticky top-36 text-center lg:text-left">
              <h2 className="text-3xl md:text-5xl font-medium tracking-tight">What we do</h2>
              <p className="mt-2 md:mt-4 text-lg">Unveiling Financial Insights with Statisense AI</p>
            </div>
          </div>
          <div className="lg:col-span-8">
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="subtle-shadow px-10 md:px-12 py-12 md:py-14">
                ...
                <h3 className="font-semibold text-xl">Harness Cutting-Edge AI</h3>
              ...
              <Card className="subtle-shadow px-10 md:px-12 py-12 md:py-14">
                ...
                <h3 className="font-semibold text-xl">Spot Trends and Anomalies</h3>
                <p className="mt-4 text-base opacity-80">
              ...
              <Card className="subtle-shadow px-10 md:px-12 py-12 md:py-14">
                ...
                <h3 className="font-semibold text-xl">Simplifying Financial Complexity</h3>
                <p className="mt-4 text-base opacity-80">
              ...
              <Card className="subtle-shadow px-10 md:px-12 py-12 md:py-14">
                ...
                <h3 className="font-semibold text-xl">Empower Your Financial Strategy</h3>
                <p className="mt-4 text-base opacity-80">
