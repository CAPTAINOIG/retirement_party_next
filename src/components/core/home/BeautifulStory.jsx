      ...
      {!!mounted && (
        <div
          ...
          style={
            theme === 'dark'
              ? {
                  background: `radial-gradient(125% 125% at 50% 100%, rgb(0, 0, 0) 40%, rgb(1 30 51 / 100%) 100%)`,
                }
              : {
                  background:
                    'radial-gradient(125% 125% at 50% 100%, rgb(255, 255, 255) 40%, rgb(173 220 255 / 70%) 100%)',
                }
          }
        />
      )}
