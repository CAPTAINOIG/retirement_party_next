...
const BigIdeas = () => {
  ...
  return (
    <div ref={sectionRef} className="light relative w-full overflow-hidden py-24">
      <div className="relative container mx-auto md:block">
        ...
        >
          <motion.h2 
            className="mx-auto max-w-4xl text-center text-4xl !leading-none font-bold tracking-tight md:text-[6rem]"
            initial={{ opacity: 0, y: 30 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
