      ...
      <div className="container">
        <div className="grid items-center gap-12 md:grid-cols-12 md:gap-16">
          <div className="relative order-1 md:order-none md:col-span-6">
            <h2 className="max-w-lg text-4xl font-semibold tracking-tighter md:text-7xl">
          ...
          <div className="relative flex w-full overflow-hidden py-4 md:col-span-4 md:justify-center md:overflow-visible">
            <div className="relative w-3/4 md:w-full">
              <div className="relative">
                <div className="absolute top-20 -left-20 hidden animate-bounce rounded-[1.2rem] bg-slate-100 px-8 py-4 md:block">
                ...
                <div className="absolute -right-60 bottom-20 hidden min-h-[250px] w-[400px] rounded-[1.2rem] bg-slate-100 px-8 py-4 md:block">
