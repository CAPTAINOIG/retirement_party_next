...
const HowImmortalityWorks = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-black">
      <div className="relative container mx-auto py-28 md:block md:py-48">
        <div className="relative">
          <h2 className="to-primary bg-linear-to-r from-green-600 bg-clip-text text-center text-[3rem] leading-none font-semibold tracking-tighter text-transparent md:text-7xl">
            How Immortality
            <br /> works with us
          </h2>
            ...
            <div className="md:p-10">
              ...
              >
                ...
                <div className="mt-6 rounded bg-[#222329] p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-400">Select a template of your choice to visualize your data</p>
                </div>
              </motion.div>
            </div>
