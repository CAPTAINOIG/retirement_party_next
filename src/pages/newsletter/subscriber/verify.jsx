  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full bg-slate-100 flex flex-col">
        <div
          className="bg-white shadow-md rounded-2xl p-16 my-auto w-full min-h-[300px] max-w-lg mx-auto flex flex-col">
          {
            isLoading ? (
                ...
                }
                {
                  view === 'success' && (
                    <div className="text-center flex flex-col items-center justify-center my-auto">
                      ...
                      <h2 className="text-3xl font-semibold max-w-xs mt-8">
